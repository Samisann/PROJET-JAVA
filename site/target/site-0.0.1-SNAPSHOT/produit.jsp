...
<%@ page 
 ...
 <%
  ...
  if(request.getAttribute("sports")!=null){
	  produits = (ArrayList<Produit>)request.getAttribute("produit");
  }
%>
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          ...
          <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group mr-2">
		   		<a href="create-form.jsp" class="btn btn-sm btn-primary">Enregistrer</a>        
            </div>
          </div>
        </div>
                ...
                <table class="table">
                  ...
                  %>
                    <tr>
                      <td><%= p.getLibelle()%></td>
                      <td>
                          <a class="btn btn-sm btn-success" href="modifierSport?codeSport=<%= p.getCode()%>">Modifier</a>
                            <!-- Button trigger modal -->
                          <a href="deleteProduit?codeProduit=<%= p.getCode()%>" class="btn btn-sm btn-danger">
                            supprimer
                          </a>
                      </td>
                    </tr>
